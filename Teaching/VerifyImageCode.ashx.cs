...
{
    /// <summary>
    /// VerifyImageCode 的摘要说明
    /// </summary>
    public class VerifyImageCode : IHttpHandler, IRequiresSessionState
    {
        public void ProcessRequest(HttpContext context)
        {
            VeriCode.Alphabet(context, "VerifyCode", 4, 14, 55, 27);
        }
    ...
    public class VeriCode : BaseVeriCode
    {
        ...
        /// <param name="imgHeiht">图片高度</param>
        /// <param name="stainLenght">噪音点长度</param>
        public static void Arithmetic(HttpContext context, string sessionKey, int fontSize = 11, int imgWidth = 65,
                                      int imgHeiht = 23, int stainLenght = 10)
        {
            ...
            context.Session.Add(sessionKey, result.ToString());
            context.Session.Timeout = AppConfig.Instance.SessionTimeout.ToInt();
        ...
        public static void Alphabet(HttpContext context, string sessionKey, int codeLenght = 4, int fontSize = 12,
                                    int imgWidth = 60, int imgHeiht = 20, int stainLenght = 30)
        {
            ...
            context.Session.Add(sessionKey, code);
            context.Session.Timeout = AppConfig.Instance.SessionTimeout.ToInt();
